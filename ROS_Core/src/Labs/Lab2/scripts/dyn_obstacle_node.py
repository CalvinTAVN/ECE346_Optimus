...
class DynObstacle():
    def __init__(self):
        ...
        # http://wiki.ros.org/dynamic_reconfigure/Tutorials/SettingUpDynamicReconfigureForANode%28python%2
        
        self.config_srv = Server(configConfig, self.dynamic_reconfigure_callback)
